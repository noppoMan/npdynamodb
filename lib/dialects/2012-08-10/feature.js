...
Feature.prototype.createTable = function(builder){
  ...
  _.each(builder.childBuilders, function(def){
    ...
    items[indexType].push(_.extend(tableInfo, def._schema.tableInfo));
  });

  this.conditions = _.extend(this.conditions, items);
}
...
Feature.prototype.run = function(promiseInterface, cb){
  ...
  return this.client[this.nextThen](params)[promiseInterface](function(data){
